###############################################################################################
# Settings file used for the computations of the Fisher matrix and SNR results. Sets the experiment,
# binning scheme as well as many parameters needed in our analysis.
##############################################################################################
...
expt_name='hirax'#'meerkat'#'hirax'
expt_mode='interferometer'
nu21 = 1420.405 # MHz

num_z_bins = 4
Z_BIN_FORMAT = 'POWERLAW'#'LINEAR_100MHz_BINS'#			'POWERLAW'
