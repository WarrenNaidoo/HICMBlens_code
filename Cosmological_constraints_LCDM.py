...
# Fisher matrices for the LCDM case and used the Full21cmblens_primary_functions.py module to plot
# the results.
...
for i in range(0,4):
    ...
    fid_label, fid_values, fisher_3params_21 = bl.get_three_param_FisherMatrix_Cl_21_21_auto_LCDM(zbin_prop)
    fid_label_kappa, fid_values_kappa, fisher_kappa = bl.get_Clkappa_distance_params_fisher_LCDM(zbin_prop)
    fid_label_bispec, fid_values_bispec, fisher_bispec = bl.get_distance_params_bispec_fisher_LCDM(zbin_prop)
...
# Make contour plot
Fpm.plot_multiple_cov_ellipses('Cosmological Constraints with Prior' , zbin_prop.z_A, fid_val, Prior_list , Prior_names , names_params )

# Print errors on HIRAX + Planck and Combined + Planck
...
Fpm.plot_multiple_ellipse_sub(twod_mean, twod_cov_matrix0, twod_label, axs1, 0, color='C0')
Fpm.plot_multiple_ellipse_sub(twod_mean, twod_cov_matrix1, twod_label, axs1, 1, color='C1')
Fpm.plot_multiple_ellipse_sub(twod_mean, twod_cov_matrix2, twod_label, axs1, 2, color='C2')
Fpm.plot_multiple_ellipse_sub(twod_mean, twod_cov_matrix3, twod_label, axs1, 3, color='C3')
