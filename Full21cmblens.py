...
def Cl_kappa_distance_derivs(ell_arr, y_arr, zbin_prop, fid_params, bias_var=1., gamma_var=1.): # 21cm angular PS at z vs ell,y
   ...
   ### For nonlinear cases sigma_nl must add extra terms dlogpk_dk + drsd_dk + dbias_k below as in Bull et al.
    ...
    deriv_aperp_integral = W_kappa_over_chi_sq*(dlogpk_dk)*daperp_k/((chi_max - chi_min)*(P_spl_k(ktot_2d_arr)))

    deriv_aperp = ( (2./aperp)) * Cl_kappa_auto_ell_y_2d_arr + deriv_aperp_integral
    deriv_apar = 0.0 #( (dlogpk_dk)*dapar_k  ) * Cl_kappa_auto_ell_y_2d_arr
    ...
    dC_dns = 0.0#np.log(ktot_2d_arr/0.05)*Cl_kappa_auto_ell_y_2d_arr
...
def get_three_param_FisherMatrix_Cl_21_21_auto(zbin_prop, num_k_bins_ell = 15, num_k_bins_y=14):
    ...
    Cl_Abao,Cl_sig8, Cl_b1, Cl_b2, Cl_f, Cl_aperp, Cl_apar = Cl21_Distance_derivs(zbin_prop, ell_arr_ltd, y_arr_ltd, fid_fisher_params, bias_var=1., gamma_var=1.)
...
def get_Clkappa_distance_params_fisher(zbin_prop, num_k_bins_ell = 15, num_k_bins_y=14):
    ...
    Cl_sig8, Cl_ns, Cl_Om, Cl_h = Cl_kappa_distance_derivs(ell_arr_ltd, y_arr_ltd, zbin_prop, fid_fisher_params, bias_var=1., gamma_var=1.)
...
def get_distance_params_bispec_fisher(zbin_prop, num_k_bins_ell = 15, num_k_bins_y=14):
    ...
    Bl_Abao,Bl_sig8,Bl_b1,Bl_b2 ,Bl_f,Bl_aperp, Bl_apar =  bispec_distance_derivs(ell_arr_ltd, y_arr_ltd, zbin_prop, fid_fisher_params, bias_var=1., gamma_var=1.)
