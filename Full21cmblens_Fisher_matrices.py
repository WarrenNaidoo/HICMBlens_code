...
def get_three_param_FisherMatrix_Cl_21_21_auto_LCDM(zbin_prop, num_k_bins_ell = 15, num_k_bins_y=14):
    ...
    fid_fisher_params = np.array([Abao,sig8, b1_zA, ns, f_zA, aperp, apar])
    n_fisher_params = fid_fisher_params.size

    Cl_Abao,Cl_sig8, Cl_b1, Cl_ns, Cl_f, Cl_aperp, Cl_apar = Cl21_Distance_derivs_LCDM(zbin_prop, ell_arr_ltd, y_arr_ltd, fid_fisher_params, bias_var=1., gamma_var=1.)

    Cl_signal = Fpm.Cl_21_auto_ell_y_zA(ell_arr_ltd, y_arr_ltd, zbin_prop, bias_var=1., gamma_var=1.)

    parameter_deriv_C_ell_y_arr = np.array([Cl_Abao,Cl_sig8, Cl_b1, Cl_ns, Cl_f, Cl_aperp, Cl_apar])
    ...
    fid_param_label = ['Abao','sig8','b1','ns','f', 'aperp', 'apar']
...
def get_distance_params_bispec_fisher_LCDM(zbin_prop, num_k_bins_ell = 15, num_k_bins_y=14):
    ...
    Bl_Abao,Bl_sig8,Bl_b1,Bl_ns ,Bl_f,Bl_aperp, Bl_apar =  bispec_distance_derivs_LCDM(ell_arr_ltd, y_arr_ltd, zbin_prop, fid_fisher_params, bias_var=1., gamma_var=1.)

    Bl_signal = Fpm.integ_bispec_kappa_21_21_ell_y_zA(ell_arr_ltd, y_arr_ltd, zbin_prop, bias_var=1., gamma_var=1.)


    parameter_deriv_ell_y_arr = np.array([Bl_Abao,Bl_sig8,Bl_b1,Bl_ns,Bl_f,Bl_aperp, Bl_apar])#,Bl_Omega_HI # parameter_deriv_ell_y_arr[ii,]
