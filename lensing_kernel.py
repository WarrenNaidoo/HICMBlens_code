############################################################################################################################
# Computes the CMB lensing kernel W_kappa as a function of redshift ( or chi) and then also computes the Fourier transform
# k_par space W_kappa kernel. This kernel is used in CMB lensing power spectrum, the bispectrum and the Fourier
# space W_kappa in the 2pt cross-correlation.
############################################################################################################################
